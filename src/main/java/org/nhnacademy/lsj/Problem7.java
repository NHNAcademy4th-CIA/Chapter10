...
import org.nhnacademy.lsj.textio.TextIO;
...
class SimpleInterpreter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SimpleInterpreter.class);

    enum Functions {SIN, COS, TAN, ABS, SQRT, LOG}
    ...
    public static void run() {
        ...
        sb.append("\n\nEnter commands; press return to end.")
                .append("Commands must have the form:\n")
                .append("      print <expression>")
                .append("  or")
                .append("      let <variable> = <expression>");
        ...
        while (true) {
            ...
            try {
                ...
                logger.warn("*** Discarding input:  \" + TextIO.getln()");
            }
        }
    ...
    private static double primaryValue() throws ParseError {
        ...
        if (Character.isDigit(ch)) {
            ...
            if (obj == null) {
                throw new ParseError("Unknown word ");
            }
